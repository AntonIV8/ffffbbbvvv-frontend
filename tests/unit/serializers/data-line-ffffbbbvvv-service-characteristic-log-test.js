...
moduleForModel('data-line-ffffbbbvvv-service-characteristic-log', 'Unit | Serializer | data-line-ffffbbbvvv-service-characteristic-log', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-service-characteristic-log',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
