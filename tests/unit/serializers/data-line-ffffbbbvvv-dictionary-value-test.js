...
moduleForModel('data-line-ffffbbbvvv-dictionary-value', 'Unit | Serializer | data-line-ffffbbbvvv-dictionary-value', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-dictionary-value',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
