...
moduleForModel('data-line-ffffbbbvvv-product-catalog', 'Unit | Serializer | data-line-ffffbbbvvv-product-catalog', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-product-catalog',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
