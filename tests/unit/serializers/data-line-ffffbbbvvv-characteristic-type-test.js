...
moduleForModel('data-line-ffffbbbvvv-characteristic-type', 'Unit | Serializer | data-line-ffffbbbvvv-characteristic-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-characteristic-type',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
