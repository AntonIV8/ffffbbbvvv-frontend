...
moduleForModel('data-line-ffffbbbvvv-cardinality-type', 'Unit | Serializer | data-line-ffffbbbvvv-cardinality-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-cardinality-type',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
