...
moduleForModel('data-line-ffffbbbvvv-service-spec-acl', 'Unit | Serializer | data-line-ffffbbbvvv-service-spec-acl', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-service-spec-acl',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
