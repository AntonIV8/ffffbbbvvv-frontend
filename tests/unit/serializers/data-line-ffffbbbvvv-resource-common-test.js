...
moduleForModel('data-line-ffffbbbvvv-resource-common', 'Unit | Serializer | data-line-ffffbbbvvv-resource-common', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-resource-common',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
