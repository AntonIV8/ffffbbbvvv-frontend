...
moduleForModel('data-line-ffffbbbvvv-resource-shared', 'Unit | Serializer | data-line-ffffbbbvvv-resource-shared', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-resource-shared',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
