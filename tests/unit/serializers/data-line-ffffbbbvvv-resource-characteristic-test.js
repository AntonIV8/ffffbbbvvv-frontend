...
moduleForModel('data-line-ffffbbbvvv-resource-characteristic', 'Unit | Serializer | data-line-ffffbbbvvv-resource-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-resource-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
