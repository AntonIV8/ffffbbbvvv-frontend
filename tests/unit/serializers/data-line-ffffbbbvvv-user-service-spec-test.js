...
moduleForModel('data-line-ffffbbbvvv-user-service-spec', 'Unit | Serializer | data-line-ffffbbbvvv-user-service-spec', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-user-service-spec',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
