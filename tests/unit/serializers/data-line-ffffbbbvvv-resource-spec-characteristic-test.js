...
moduleForModel('data-line-ffffbbbvvv-resource-spec-characteristic', 'Unit | Serializer | data-line-ffffbbbvvv-resource-spec-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-resource-spec-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
