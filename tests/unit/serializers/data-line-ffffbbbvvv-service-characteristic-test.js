...
moduleForModel('data-line-ffffbbbvvv-service-characteristic', 'Unit | Serializer | data-line-ffffbbbvvv-service-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-service-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
