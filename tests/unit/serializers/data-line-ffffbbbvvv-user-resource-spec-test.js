...
moduleForModel('data-line-ffffbbbvvv-user-resource-spec', 'Unit | Serializer | data-line-ffffbbbvvv-user-resource-spec', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-user-resource-spec',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
