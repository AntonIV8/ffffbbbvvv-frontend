...
moduleForModel('data-line-ffffbbbvvv-resource-usage-spec', 'Unit | Serializer | data-line-ffffbbbvvv-resource-usage-spec', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-resource-usage-spec',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
