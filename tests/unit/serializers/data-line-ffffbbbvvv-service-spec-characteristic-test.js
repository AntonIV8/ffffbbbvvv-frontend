...
moduleForModel('data-line-ffffbbbvvv-service-spec-characteristic', 'Unit | Serializer | data-line-ffffbbbvvv-service-spec-characteristic', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:data-line-ffffbbbvvv-service-spec-characteristic',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
